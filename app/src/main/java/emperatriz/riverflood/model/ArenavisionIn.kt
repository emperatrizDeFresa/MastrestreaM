...
class ArenavisionIn private constructor() : GestorPagina {
    ...
    val javascript: String
        get() = "(function() { return ('<html><table>'+document.getElementsByTagName('html')[0].innerHTML+'</table></html>'); })();"

    var url: String = "http://arenavision.in"
        get() = "http://arenavision.in"
    ...
    fun parseDataMain(html: String) {
        ...
        try {
            ...
            scheduleUrl = "http://www.arenavision.in/guide"
        }
    ...
    private fun parseData3() {
        ...
        if (cola.size > 0) {
            ...
            Sys.init().w!!.loadUrl("http://arenavision.in/" + ("0" + cola.peek()).substring(cola.peek().length - 1))
        } else {
    ...
    companion object {
        ...
        private var instance: ArenavisionIn? = null

        fun init(): ArenavisionIn {
            if (instance == null)
                instance = ArenavisionIn()
            return instance!!
        }
    }
}
