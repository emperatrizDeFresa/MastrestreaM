...
public class ArenavisionIn implements GestorPagina {
    ...
    public static ArenavisionIn init(){
        if (instance==null)
            instance = new ArenavisionIn();
        return instance;
    }

    private ArenavisionIn(){}
...
//                        }
    ...
    private void parseData3(){
        ...
        if (cola.size()>0){
            ...
            Sys.init().w.loadUrl("http://www.arenavision.in/av"+cola.peek());
        }else{
